	...
	<center>
		...
		<form action="BoardUpdateProc.jsp" method="post">
				...
				<tr height="40">
					...
					<td width="480" colspan="3">&nbsp; <input type="text" name="subject" value="<%= bean.getSubject()%>" size="70"></td>
				</tr>
				
				<tr height="40">
					<td align="center" width="120">패스워드</td>
					<td width="480" colspan="3">&nbsp; <input type="password" name="password" size="70"></td>
				</tr>
