...
import com.example.spring02.service.memo.MemmoService;
...
public class MemoController {
	...
	/* REST (REpresentativ State Transfer)
	게시물별로 고유한 주소값을 가짐 RESTful */
